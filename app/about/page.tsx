...
export const metadata: Metadata = {
  title: "About | SamCux",
  metadataBase: new URL("https://samcuxx.vercel.app/about"),
  description:
    "Learn more about my skills, experience and technical background",
  openGraph: {
    title: "About | SamCux",
    url: "https://samcuxx.vercel.app/about",
    description:
      "Learn more about my skills, experience and technical background",
    images:
          ...
          <div key={data._id}>
            <section className="relative grid grid-cols-1 lg:grid-cols-custom gap-x-6 justify-items-center">
              <div className="order-2 lg:order-none">
                <Slide>
                  <h1 className="mb-8 text-3xl font-semibold tracking-tight font-incognito sm:text-5xl lg:leading-tight basis-1/2">
